...
<?php
  ...
  $result = mysqli_query($conn, $sql);
	$sql_max = "SELECT MAX(id) as max FROM recommended_journal;";
    ...
    <table class="table table-hover">
        <tbody>
          <tr>
            ...
            <td class="text-center"><input type="text" class="form-control" id="id" name="id" placeholder="<?= translate("推薦期刊代碼") ?>"></td>
          </tr>
          <tr>
            <td class="text-center"><?= translate("推薦期刊名稱") ?></td>
            <td class="text-center"><input type="text" class="form-control" id="name" name="name" placeholder="<?= translate("推薦期刊名稱") ?>"></td>
          </tr>
			<tr>
            <td class="text-center"><?= translate("索引") ?></td>
            <td class="text-center"><input type="text" class="form-control" id="science_citation_index" name="science_citation_index" placeholder="<?= translate("索引") ?>"></td>
          </tr>
			<tr>
            <td class="text-center"><?= translate("限制條件") ?></td>
            <td class="text-center"><input type="text" class="form-control" id="restrictions" name="restrictions" placeholder="<?= translate("限制條件") ?>"></td>
          </tr>
			<tr>
            <td class="text-center"><?= translate("推薦流程") ?></td>
            <td class="text-center">
				<textarea rows="2" type="text" class="form-control" id="recommendation_process" name="recommendation_process" placeholder="<?= translate("推薦流程") ?>"></textarea></td>
			</td>
          </tr>
        </tbody>
     </table>
...
if($_GET['action']=="save"){
	$id = $_POST['id']; 
  $name = $_POST['name']; 
	$science_citation_index = $_POST['science_citation_index']; 
  $restrictions = $_POST['restrictions']; 
	$recommendation_process = $_POST['recommendation_process']; 
	mysqli_query($conn,"insert into recommended_journal set 
      id='$id'
      , name='$name'
      , science_citation_index='$science_citation_index'
      , restrictions='$restrictions'
      , recommendation_process='$recommendation_process'
			");
	echo "<script language='javascript'> location='recommended_journal.php';</script>"; 	
}}
?>
<script>
	function gohome(){

		...
		<span class="navbar-brand pull-right" style="margin-top:-5px; display: none">
			<div class="dropdown">
			  ...
			  <ul class="dropdown-menu">
				<li><a href="/papers/admin/reviewerLogin.php?lang=zh-TW"><?= translate("中文") ?></a></li>
				<li><a href="/papers/admin/reviewerLogin.php?lang=en_US"><?= translate("English") ?></a></li>
			  </ul>
			</div>
		</span>
		
		<span class="navbar-brand pull-right" style="font-size: 14px;cursor:hand"><a style="color: white; text-decoration:none;" href="/papers/admin/reviewerLogin.php?lang=en_US">English</a></span>
		<span class="navbar-brand pull-right" style="font-size: 14px; color: white;" >&nbsp;&nbsp;|&nbsp;&nbsp;</span>
		<span class="navbar-brand pull-right" style="font-size: 14px;cursor:hand"><a style="color: white; text-decoration:none;" href="/papers/admin/reviewerLogin.php?lang=zh-TW">繁體中文</a></span>

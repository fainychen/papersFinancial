    ...
    <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center"><input type="text" class="form-control" id="date" name="date" placeholder="<?= translate("請輸入日期, 格式: YYYY-MM-DD") ?>"></td>
          </tr>
          <tr>
            <td class="text-center"><?= translate("作者") ?></td>
            <td class="text-center"><input type="text" class="form-control" id="author" name="author" placeholder="<?= translate("作者") ?>"></td>
          </tr>
          <tr>
            <td class="text-center"><?= translate("標題") ?></td>
            <td class="text-center"><input type="text" class="form-control" id="title" name="title" placeholder="<?= translate("請輸入標題, 顯示於首頁, 建議字數為15個字以內") ?>"></td>
          </tr>
          <tr>
            <td class="text-center"><?= translate("簡要說明") ?></td>
            <td class="text-center"><textarea type="text" class="form-control" id="content" name="content" placeholder="<?= translate("請輸入簡要說明, 顯示於首頁, 建議字數為200字以內") ?>"></textarea></td>
          </tr>
          <tr>
            <td class="text-center"><?= translate("詳細內容") ?></td>
            <td class="text-center">
            	<textarea cols="140" rows="36" id="full_content" name="full_content"></textarea>
            </td>
          </tr>
          <tr>
            <td class="text-center"><?= translate("是否顯示") ?></td>
            <td class="text-center"><input type="text" class="form-control" id="visible" name="visible" placeholder="<?= translate("請輸入是否顯示, 格式: 1顯示; 0不顯示") ?>"></td>
          </tr>
          <tr style="visibility:hidden">
            <td class="text-center"><?= translate("編號") ?></td>
            <td class="text-center"><input type="text" class="form-control" id="no" name="no" value="<?php echo $row_max[0] + 1; ?>" placeholder="<?= translate("編號") ?>"></td>
          </tr>
        </tbody>
     </table>
  </form>

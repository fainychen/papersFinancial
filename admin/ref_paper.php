...
<nav class="navbar navbar-default">
  ...
  <div class="container">
    ...
    <table class="table table-hover">
        <thead>
          <tr>
            <th class="text-center"><?= translate("論文主題代碼") ?></th>
            <th class="text-center"><?= translate("論文主題名稱") ?></th>						
            <th class="text-center"><?= translate("審查委員數") ?></th>
            <th class="text-center"><?= translate("接受最大篇數") ?></th>						
            <th class="text-center"><?= translate("接受並推薦到期刊最大篇數") ?></th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center"><?=$row->committee_qty; ?></td>
            <td class="text-center"><?=$row->accept_max; ?></td>
						
            <td class="text-center"><?=$row->recommend_max; ?></td>
            <td class="text-center">
                <button class="glyphicon glyphicon-pencil btn btn-default" onclick="self.location.href='ref_paper_edit.php?action=modify&hideID=<?=$row->id; ?>'"></button>
...
<script>
	function additem(a){
		location.href='ref_paper_add.php';
	}
	function deleteitem(a){
		answer = confirm("<?= translate('您確定要刪除此筆資料嗎？') ?>"	);
		if (answer) {
			location.href='ref_paper_edit.php?action=delete&hideID='+a+'';

    ...
    <table class="table table-hover">
        <thead>
          <tr>
            ...
            <th class="text-center"><?= translate("名稱") ?></th>
            <th class="text-center"><?= translate("電子郵件") ?></th>
            <th class="text-center"><?= translate("權限") ?></th>
          ...
          <tr>
            ...
            <td class="text-center">
						...
						if ($row->role == '0') {
							...
							echo translate("大會工作人員");
						} else if ($row->role == '4') {
							echo translate("系統管理員");
						} 
						?>
						</td>
            <td class="text-center">
                <button class="glyphicon glyphicon-pencil btn btn-default" onclick="self.location.href='admin_edit.php?action=modify&hideID=<?=$row->id; ?>'"></button>
...
<script>
	...
	function deleteitem(a){
		...
		if (answer) {
			location.href='admin_edit.php?action=delete&hideID='+a+'';
		}
	}
</script>

...
<?php
  ...
  $result = mysqli_query($conn, $sql);
	$sql_max = "SELECT MAX(no) as max FROM email_log;";
    ...
    <table class="table table-hover">
        <tbody>
          <tr>
            ...
            <td class="text-center"><input type="text" class="form-control" id="title" name="title" placeholder="<?= translate("標題") ?>"></td>
          </tr>
          <tr>
            <td class="text-center"><?= translate("收件信箱") ?></td>
            <td class="text-center"><input type="text" class="form-control" id="mail" name="mail" placeholder="<?= translate("收件信箱") ?>"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="text-center"><input type="text" class="form-control" id="send_time" name="send_time" placeholder="<?= translate("寄送時間") ?>"></td>
          </tr>
          <tr style="visibility:hidden">
            <td class="text-center"><?= translate("編號") ?></td>
            <td class="text-center"><input type="text" class="form-control" id="no" name="no" placeholder="<?= translate("編號") ?>"></td>
          </tr>
        </tbody>
     </table>
  </form>
...
if($_GET['action']=="save"){
	...
	mysqli_query($conn,"insert into email_log set 
      ...
      , send_time='$send_time'
			");
	echo "<script language='javascript'> location='sysEmaillog.php';</script>"; 	
}}
?>
<script>
	function gohome(){

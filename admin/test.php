  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 page-header">
		...
		<a href="http://140.115.197.31:8080/papers/admin/mb_add.php"><?= translate("作者註冊請點我") ?></a></p>
      </div>
    </div>
...
<footer class="text-center">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <p>Copyright c 2021 TFA conference submission system. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>

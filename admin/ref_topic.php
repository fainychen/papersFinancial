...
<nav class="navbar navbar-default">
  ...
  <div class="container">
    ...
    <table class="table table-hover">
        <thead>
          <tr>
            <th class="text-center"><?= translate("類別代碼") ?></th>
            <th class="text-center"><?= translate("類別名稱") ?></th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
                <button class="glyphicon glyphicon-pencil btn btn-default" onclick="self.location.href='ref_topic_edit.php?action=modify&hideID=<?=$row->no; ?>'"></button>
...
<script>
	function additem(a){
		location.href='ref_topic_add.php';
	}
	function deleteitem(a){
		answer = confirm("<?= translate('您確定要刪除此筆資料嗎？') ?>"	);
		if (answer) {
			location.href='ref_topic_edit.php?action=delete&hideID='+a+'';
			//alert(a);
		}
	}
</script>

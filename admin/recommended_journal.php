...
<nav class="navbar navbar-default">
  ...
  <div class="container">
    ...
    <table class="table table-hover">
        <thead>
          <tr>
            <th class="text-center"><?= translate("推薦期刊代碼") ?></th>
...
<script>
	function additem(a){
		location.href='recommended_journal_add.php';
	}
	function deleteitem(a){
		answer = confirm("<?= translate('您確定要刪除此筆資料嗎？') ?>"	);
		if (answer) {
			location.href='recommended_journal_edit.php?action=delete&hideID='+a+'';

...
<nav class="navbar navbar-default">
  ...
  <div class="container">
    ...
    <table class="table table-hover">
        <thead>
          <tr>
            <th class="text-center"><?= translate("日期") ?></th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
                <button class="glyphicon glyphicon-pencil btn btn-default" onclick="self.location.href='home_edit.php?action=modify&hideID=<?=$row->no; ?>'"></button>
...
<script>
	function additem(a){
		location.href='home_add.php';
	}
	function deleteitem(a){
		answer = confirm("<?= translate('您確定要刪除此筆資料嗎？') ?>"	);
		if (answer) {
			location.href='home_edit.php?action=delete&hideID='+a+'';
			//alert(a);
		}
	}
</script>

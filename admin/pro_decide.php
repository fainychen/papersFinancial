  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 page-header">
        <h2><?= translate("審查結果寄發") ?></h2>
      </div>
    </div>
    <a style="display: none" class="glyphicon glyphicon-plus btn btn-default" onclick="additem()"></a>
    <br/>
    <br/>
    <table class="table table-hover">
        ...
        <tbody>
          <?php
			...
			{			
				if ($row->paper_status == '4' ||$row->paper_status == '5' ||$row->paper_status == '6'  ){
          ...
          <tr>
            ...
            <td class="text-center"><?=$row->submission_no; ?></td>
            <td class="text-center"><?=$row->topic; ?></td>
            <td class="text-center"><?php
						if ($row->paper_status == '4') {
							echo translate("接受");
